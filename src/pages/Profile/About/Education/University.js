...
import UniversityIcon from "../../../../assets/about/University.png";
...
export default ({ universities, isMe, setUniversities }) => {
  ...
  return (
    <Works>
      {isMe() && universities.length < 1 && !newIns && (
        <AddButton
          variant="outlined"
          startIcon={<img style={{ width: "20px" }} src={UniversityIcon} />}
          onClick={() => setNewIns(true)}
        >
          Add University
        </AddButton>
      )}
