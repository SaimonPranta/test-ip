...
import { getFutureDate } from "../../../shared/functions/getFutureDate";
...
const Index = () => {
  ...
  const handleShareToStory = async () => {
    ...
    axios
      .post(`${BACKEND_URL}/profile/story/create`, formData, {
        headers: userHeader(),
      })
      .then((response) => {
    ...
    <div className="create-story">
      <div className="add-content">
              ...
              {showListDropdown.privacy && (
                <div className="dropdown-wrapper">
                  <ListDropdown
                    ...
                    totalDataItem={totalStories}
                    setTotalDataItem={setTotalStories}
        ...
        <div className="writing-section">
          ...
          <div className="add-text-btn">
            {activeText !== -1 && storyText !== "" ? (
              <button onClick={() => handleClearTextToStory()}>Save</button>
            ) : (
              <button onClick={() => handleAddTextToStory()}>Add Text</button>
            )}
          </div>
        </div>
        ...
        <DiscardModal
          ...
          title="Do you want to discard your story?"
        />
      </div>
